// ============================================================
//  SM CONSULTORES (con gráfico) – vistaPrevia_Grafico.js
//  Datos por defecto + bloques dinámicos de competencias + render de la
//  vista previa (incluye la llamada a renderGraficoCompetencias).
//  Depende de: utils.js (fmtDate, fmtDateLong, val, setText),
//  grafico_Grafico.js (renderGraficoCompetencias)
// ============================================================
const defaultComps = [
